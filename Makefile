...
bin/nyeh.x: obj/main.o obj/Cam.o obj/HighguiCam.o obj/UvcCam.o obj/HistogramHand.o obj/3DView.o obj/GameUpdater.o obj/Net.o obj/NetCam.o obj/NetGame.o obj/ScoreRenderer.o obj/HandToModel.o
	$(link)
